                        ...
                        <form @submit.prevent="submit">
                            <div class="border_box p_24 white_bc mb_32">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4"><div class="form-group"><label>رقم السجل التجاري</label><input type="text" class="form-control" v-model="form.commercial_register_no"></div></div>
